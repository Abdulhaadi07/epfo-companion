...
type MobileNavigationProps = { isAuthenticated: boolean; navigation: readonly NavigationItem[]; signOutAction: () => Promise<void> };

export function MobileNavigation({ isAuthenticated, navigation, signOutAction }: MobileNavigationProps) {
